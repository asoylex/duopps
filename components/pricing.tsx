  ...
  const plans = [
    {
      ...
      features: [
        t("pricing.feature.digitalPresence"),
        t("pricing.feature.modernDesign"),
        t("pricing.feature.optimizedPage"),
        t("pricing.feature.readyToGrow"),
    ...
    },
    {
      ...
      features: [
        t("pricing.feature.strategicLanding"),
        t("pricing.feature.sections5"),
        t("pricing.feature.formWhatsapp"),
    ...
    },
    {
      ...
      features: [
        ...
        t("pricing.feature.advancedLanding"),
        t("pricing.feature.customFlows"),
        t("pricing.feature.scalableTech"),
        t("pricing.feature.projectSupport"),
      ],
    },
  ]
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {plans.map((plan, index) => (
            <Card
              key={index}
              className={`reveal relative border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 ${plan.popular ? "border-accent ring-1 ring-accent" : ""
                }`}
